# Olá, eu sou a Natalia Almeida! 👋

Sou desenvolvedora em formação, com foco em **Front-end** e **Python**.
Estou em transição de carreira e construindo minha trajetória na área de TI através de projetos práticos — automação, análise de dados, inteligência artificial e desenvolvimento web.

---

## 🚀 Sobre mim

- 🎓 Cursando Tecnologia em Gestão da TI — conclusão em Dezembro/2026
- 💻 Estudando: Python, HTML, CSS, JavaScript
- 🌱 Sempre aprendendo e buscando minha primeira oportunidade na área
- 📍 São Gonçalo, RJ
